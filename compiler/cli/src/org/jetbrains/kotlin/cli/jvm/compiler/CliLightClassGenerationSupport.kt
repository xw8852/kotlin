...
class CliLightClassGenerationSupport(
    ...
    private val ultraLightSupport: KtUltraLightSupport by lazyPub {
        CliLightClassSupport(project, languageVersionSettings() ?: KotlinTypeMapper.LANGUAGE_VERSION_SETTINGS_DEFAULT)
    }
    ...
    private fun getContext(): LightClassConstructionContext =
        LightClassConstructionContext(traceHolder.bindingContext, traceHolder.module, languageVersionSettings())
