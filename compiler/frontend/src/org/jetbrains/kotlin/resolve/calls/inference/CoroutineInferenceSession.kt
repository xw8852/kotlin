...
class CoroutineInferenceSession(
    ...
    override fun shouldRunCompletion(candidate: KotlinResolutionCandidate): Boolean {
        ...
        /*
         * We don't want to complete call if there are any constrains which connects type variable from candidate and
         *   stub variable from session
         */
        return !storage.initialConstraints.any { constraint ->
            val a = constraint.a as KotlinType
            val b = constraint.b as KotlinType
            (a.containsStubType() && b.containsNotFixedTypeVariable(storage)) ||
                    (b.containsStubType() && a.containsNotFixedTypeVariable(storage))
