...
private class FirSupertypeResolverVisitor(
    ...
    private fun prepareScopeForNestedClasses(klass: FirClass<*>): ScopePersistentList {
        return supertypeComputationSession.getOrPutScopeForNestedClasses(klass) {
            ...
            scopes.addAll(createScopesForNestedClasses(klass, session, scopeSession, supertypeComputationSession))
        }
    }
...
private fun ScopePersistentList.pushIfNotNull(scope: FirScope?): ScopePersistentList = if (scope == null) this else add(scope)
