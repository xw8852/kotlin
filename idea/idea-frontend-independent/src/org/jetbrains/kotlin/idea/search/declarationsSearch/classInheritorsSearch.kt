...
import org.jetbrains.kotlin.asJava.getLightClassWithBuiltinMapping
...
fun HierarchySearchRequest<*>.searchInheritors(): Query<PsiClass> {
    val psiClass: PsiClass = when (originalElement) {
        is KtClassOrObject -> runReadAction { originalElement.getLightClassWithBuiltinMapping() ?: KtFakeLightClass(originalElement) }
