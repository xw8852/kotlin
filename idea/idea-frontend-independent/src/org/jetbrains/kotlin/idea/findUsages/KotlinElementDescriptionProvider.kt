...
open class KotlinElementDescriptionProviderBase : ElementDescriptionProvider {
    ...
    //TODO: Copied from org.jetbrains.kotlin.idea.util.string.StringUtils
    ...
    //Add FIR support for org.jetbrains.kotlin.idea.refactoring.rename.RenameJavaSyntheticPropertyHandler
    protected open val PsiElement.isSyntheticPropertyWrapper: Boolean get() = false

    //Add FIR support for org.jetbrains.kotlin.idea.refactoring.rename.RenameKotlinPropertyProcessor
    protected open val PsiElement.isPropertyMethodWrapper: Boolean get() = false
    ...
    override fun getElementDescription(element: PsiElement, location: ElementDescriptionLocation): String? {
        ...
        fun elementKind() = when (targetElement) {
            ...
            is KtImportAlias -> KotlinBundle.message("find.usages.import.alias")
                ...
                when {
                    targetElement.isSyntheticPropertyWrapper -> KotlinBundle.message("find.usages.property")
                    targetElement.isPropertyMethodWrapper -> KotlinBundle.message("find.usages.property.accessor")
                    isFacadeClass(targetElement) -> KotlinBundle.message("find.usages.facade.class")
                    else -> null
                }
            }
        }
